...
// ### removed patch "workaround_for_msvc2015_issue_v2.patch"
// ### http://postgresql.nabble.com/Building-PostgreSQL-9-6devel-sources-with-Microsoft-Visual-C-2015-td5880108.html
#if (_MSC_VER >= 1700 && _MSC_VER < 1900)//#if (_MSC_VER >= 1700 && _MSC_VER < 1800)
	_locale_t	loct = NULL;
...
#elif (_MSC_VER > 1900)//#elif (_MSC_VER >= 1800)
	_locale_t	loct = NULL;
